...
def model_selector(dataset, in_channels, ts_len, n_classes, params, model_type, results_path):
    # Model trainer
...
def train_experiment(dataset, exp_name, exp_hash, params, model_type):
    ...
    model, optimizer, scheduler, trainer = model_selector(dataset, n_channels, ts_length, n_classes, params, model_type, results_path)
